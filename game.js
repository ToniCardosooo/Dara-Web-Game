...
function setGameMode(mode){
  if (mode==0){secondPlayer=0; document.getElementById("ai-difficulty").style.display = "none";}
  else{secondPlayer=1; document.getElementById("ai-difficulty").style.display = "flex";}
}
